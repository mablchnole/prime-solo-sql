...
—-3. The bank is giving a new customer bonus! Update all records with an account_balance of 0.00 AND a transactions_attempted of 0. Give them a new account_balance of 10.00.
...
—-8. Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('mai', 'st paul', 3, 2, 0);
